...
function tienePropiedad(objeto, propiedad) {
   ...
   if (objeto.hasOwnProperty(propiedad) == true) return true   
   return false;
...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // objetoMuchosUsuarios = [usuario1 = {esPremium:'true'},]
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   for ( let index in objetoUsuario['posts']){
      count += objetoUsuario['posts'][index]['likes']
   }
   return count
...
//       counter += objetoUsuario['posts'][index]['likes'];
//    }
//    return counter;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   //    return objetoProducto.precio = objetoProducto.precio - descuento
   // }
