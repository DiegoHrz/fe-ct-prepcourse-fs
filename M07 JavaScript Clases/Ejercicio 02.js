...
class Persona {
   ...
   detalle(){
      return {
         ...
         edad: this.edad,
         domicilio: this.domicilio ////En la línea nombre: this.nombre, por ejemplo, se está creando una nueva propiedad nombre en el objeto devuelto por el método detalle() y se está asignando el valor de this.nombre a esa propiedad
      }
   }
}
